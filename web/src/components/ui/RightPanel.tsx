...
import type { TrendingBook } from "~/types/books";
...
const RightPanel = () => {
  ...
  return (
    <aside className="w-80 bg-background text-foreground p-6 pt-8 flex flex-col gap-10 overflow-y-auto lg:flex">
      {/* 1. CURRENTLY READING SECTION */}
      <section>
        <div className="bg-background border border-secondary rounded-xl p-4 shadow-sm">
          <div className="flex items-center gap-2 text-[10px] font-bold text-primary tracking-wider uppercase mb-3">
          ...
          <div className="flex gap-3">
            {/* Book Cover */}
            <div className="w-12 h-16 bg-primary rounded flex items-center justify-center p-1 shrink-0 shadow-sm border-l-2 border-background/20">
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <span className="text-xs font-medium text-foreground">62%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <h3 className="text-[10px] font-bold text-foreground/75 tracking-wider uppercase mb-4 px-1">
          Trending Books
        </h3>
        ...
        {bookData !== undefined ? (
          <div className="flex flex-col gap-4">
            {bookData.trendingBooks?.length === 0 && (
              <p className="text-xs text-foreground/75 px-1">
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="flex gap-3 items-center">
                ...
                <div className="flex-1 space-y-2.5">
                  <Skeleton
                    sx={{ bgcolor: "#E5DAC6" }}
                    className="h-3.5 w-3/4 rounded-full"
                  />
                  <Skeleton
                    sx={{ bgcolor: "#E5DAC6" }}
