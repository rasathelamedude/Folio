  ...
  return (
    <aside className="w-64 border-r border-secondary bg-background flex flex-col h-full p-6">
      ...
      <div className="mt-auto">
        <button className="w-full bg-primary hover:bg-foreground text-background rounded-xl py-3 px-4 flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer">
